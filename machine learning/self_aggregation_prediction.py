...
wb = load_workbook(filename = '/content/CoAggregators/data/aggregator_hts.xlsx')
...
drugbank_mol = []
drugbank_name = []
drugbank_file = open("/content/CoAggregators/data/drugbank5_approved_names_smiles.tsv","r")
...
outfile = open("/content/CoAggregators/data/drugbank_selfaggs_smiles.tsv","w")
